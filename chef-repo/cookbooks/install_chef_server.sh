...
if [ ! $(which chef-server-ctl) ]; then
  ...
  chef-server-ctl user-create chefadmin Chef Admin admin@webrahul.com vagrant --filename /drop/chefadmin.pem
  chef-server-ctl org-create webrahul "WebRahul" --association_user chefadmin --filename webrahul-validator.pem
fi
